...
const About = () => {
  return (
    <div className={`${inter.className} relative max-w-7xl m-auto`}>
      ...
      <div className='flex flex-wrap xl:flex-nowrap px-8 xl:px-32 xl:max-h-96 gap-5 my-20'>
      ...
      <div className='flex flex-col px-6'>
        ...
        {/* Content */}
        <div className='flex flex-wrap xl:flex-nowrap justify-center gap-5 xl:px-32 py-10'>
      ...
      <div className='xl:px-28 mt-10 px-6'>
    ...
    <div className='flex flex-wrap justify-center xl:flex-nowrap gap-5 mt-8'>
      <div className='xl:w-1/2 max-w-5xl flex flex-col gap-2 items-center xl:items-start'>
        <Image className='xl:max-h-80' src={aboutImage2} alt='About'/>
      ...
      <div className='lg:w-1/4 w-full flex flex-col gap-2 items-center xl:items-start'>
        <Image className='xl:max-h-80' src={aboutImage4} alt='About'/>
        <p className='text-xl'>The Dandy chair</p>
        <p className='text-lg -mt-1'>$99.00</p>
      </div>

      <div className='lg:w-1/4 w-full flex flex-col gap-2 items-center xl:items-start'>
        <Image className='xl:max-h-80' src={aboutImage3} alt='About'/>
        <p className='text-xl'>The Dandy chair</p>
        <p className='text-lg -mt-1'>$99.00</p>
      </div>
    </div>
