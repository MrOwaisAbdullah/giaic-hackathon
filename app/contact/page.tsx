...
const Contact = () => {
  return (
    <div className={`${poppins.className} container pt-28 -mb-28`}>
      <h2 className={`heading text-center font-semibold text-4xl`}>Get In Touch With Us</h2>
      <p className={`xl:px-40 text-center text-[#9F9F9F]`}>For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>
      ...
      <div className='flex flex-wrap xl:flex-nowrap mt-28 px-5 xl:px-28'>
        <div className={`${inter.className} pb-20 flex flex-col gap-20`}>
            ...
            <div>
                ...
                <p className='w-48'>236 5th SE Avenue, New York NY10000, United States</p>
            </div>
            </div>
            <div className='flex gap-5'>
            ...
            <div>
                ...
                <p className='w-48'>Mobile: +(84) 546-6789 <br/>
            ...
            <div>
                ...
                <p className='w-48'>Monday-Friday: 9:00 - 22:00 <br/>
...
<SlTrophy className='text-5xl' />
            <div>
                ...
                <p className='text-lg font-medium text-[#898989]'>crafted from top materials</p>
            </div>
            </div>
...
<BsPatchCheck className='text-5xl' />
            ...
            <div>
                ...
                <p className='text-lg font-medium text-[#898989]'>Dedicated support</p>
            </div>
            </div>
</div>
